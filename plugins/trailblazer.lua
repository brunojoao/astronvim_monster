return {
    ...
    lazy = false,
    config = function()
        local trail = require("trailblazer")
        trail.setup( -- Adjust these values to your liking
        {
            lang = "en",
            ...
            trail_options = {
                ...
                available_trail_mark_modes = {
                    "global_chron", "global_buf_line_sorted",
                    "global_fpath_line_sorted", "global_chron_buf_line_sorted",
